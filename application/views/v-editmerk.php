          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Update Data Merk<small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form action="<?php echo base_url().'index.php/merk/update'; ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nama<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="kode" type="hidden" value="<?php echo $u->kode_merk ?>">
                          <input name="nama" value="<?php echo $u->nama_merk ?>" type="text" id="last-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>                  
