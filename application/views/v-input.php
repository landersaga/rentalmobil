        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a href="<?php echo base_url(); ?>index.php/karyawan/out" data-toggle="tooltip" data-placement="top" title="Logout">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li>
                    <li><a href="<?php echo base_url() ?>index.php/karyawan/out"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Input Data Karyawan<small></small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form action="<?php echo base_url().'index.php/karyawan/tambah_aksi'; ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">NIK<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="<?php echo $kode; ?>" name="nik" type="text" readonly id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
