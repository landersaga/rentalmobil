                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                       <?php 
                         ...
                         ?>
                         <tr>
                           <td><?php echo $u ->id_type ?></td>
                           <td><?php echo $u->kode_merk ?></td>
                           <td><?php echo $u->nama_type ?></td>
                           <td>
                           <?php echo anchor('type/edit/'.$u->id_type,'Edit'); ?>
                            <?php echo anchor('type/hapus/'.$u->id_type,'Hapus'); ?>
                            </td>
                         </tr>
                         <?php } ?>
                      </tbody>
                    </table>
                    <center><?php echo anchor('type/tambah','Tambah Data Type'); ?></center>
                  </div>
                </div>
              </div>  
        <footer>
