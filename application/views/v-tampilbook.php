...
<html lang="en">
  <head>
    ...
    <title>Data Transaksi Booking</title>
                      ...
                      <tbody>
                       <?php 
                         ...
                         <tr>
                           ...
                           <td><?php echo $u->tgl_pinjamrencana ?></td>
                         </tr>
                         <?php } ?>
                      </tbody>
                    </table>
                    <center><?php echo anchor('booking/tambah','Tambah Data Booking'); ?></center>
                  </div>
                </div>
              </div>  
        <footer>
