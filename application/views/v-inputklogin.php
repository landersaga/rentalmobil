...
<html lang="en">
  <head>
    ...
    <title>Input Data Karyawan Login</title>
  ...
  <body class="nav-md">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="<?php echo base_url(); ?>index.php/klogin/out"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Input Data Karyawan Login<small></small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form action="<?php echo base_url().'index.php/klogin/tambah_aksi'; ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input  value="<?php if(isset($_GET['nik'])) echo $_GET['nik'] ?>" name="nik" type="text" readonly id="last-name" required="required" class="form-control col-md-7 col-xs-12">
                          <button type="button" data-target="#modalnik" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg">Search Data</button>
                          </span>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="username" type="text" id="last-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="type">
                        </div>
                      </div>                      
    ...
    <!-- /Starrr --><div class="modal fade bs-example-modal-lg" id="modalnik" tabindex="-1" role="dialog" aria-hidden="true">
                      ...
                      <tbody>
                       <?php 
                         ...
                         <tr>
                           ...
                           <td>
                             <a href="?nik=<?php echo $u->nik ?>" class="btn btn-primary"><i class="fa fa-edit ">
                             </i>Get</a>
                           </td>
                         </tr>
                         <?php } ?>
